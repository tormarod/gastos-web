...
Load and save the app's documents.
  ...
  settings.json  budgets, fixed categories and savings goals (services.budget)
...
def update_settings(fn: Callable[[dict[str, Any]], T]) -> T:
    """Apply fn to the settings document (mutating it) and save. fn may run more than once."""
